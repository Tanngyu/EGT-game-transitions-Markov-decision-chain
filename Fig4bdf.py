...
for b0 in np.arange(0, 5.25, 0.25):
    ...
    row2 = []
    row3 = []
    for DELTA in np.arange(0, 5.25, 0.25):
...
save_heatmap_to_excel(heatmap1, 'delta_b_G1.xlsx')
save_heatmap_to_excel(heatmap2, 'delta_b_G2.xlsx')
save_heatmap_to_excel(heatmap3, 'delta_b_G3.xlsx')
