...
for sigma in [0.4,0.5,0.6]:
    ...
    for delta in [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4]:
        mu = 1 - sigma
        ...
        x1[i].append(average_value[0])
        x2[i].append(average_value[1])
        x3[i].append(average_value[2])
...
markers = ['o', 's', '^']
x_values = [0.0, 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4]

plt.plot(x_values,x1[0], label=r'$G_1 - σ=0.4$', marker=markers[0], color='#5F9C61',linestyle= '-',linewidth=4,markersize=10)
plt.plot(x_values,x2[0], label=r'$G_2 - σ=0.4$', marker=markers[0], color='#B092B6',linestyle= '-',linewidth=4,markersize=10)
plt.plot(x_values,x3[0], label=r'$G_3 - σ=0.4$', marker=markers[0], color='#E38D26',linestyle= '-',linewidth=4,markersize=10)

plt.plot(x_values,x1[1], label=r'$G_1 - σ=0.5$', marker=markers[1], color='#5F9C61',linestyle= '--',linewidth=4,markersize=10)
plt.plot(x_values,x2[1], label=r'$G_2 - σ=0.5$', marker=markers[1], color='#B092B6',linestyle= '--',linewidth=4,markersize=10)
plt.plot(x_values,x3[1], label=r'$G_3 - σ=0.5$', marker=markers[1], color='#E38D26',linestyle= '--',linewidth=4,markersize=10)

plt.plot(x_values,x1[2], label=r'$G_1 - σ=0.6$', marker=markers[2], color='#5F9C61',linestyle= ':',linewidth=4,markersize=10)
plt.plot(x_values,x2[2], label=r'$G_2 - σ=0.6$', marker=markers[2], color='#B092B6',linestyle= ':',linewidth=4,markersize=10)
plt.plot(x_values,x3[2], label=r'$G_3 - σ=0.6$', marker=markers[2], color='#E38D26',linestyle= ':',linewidth=4,markersize=10)


plt.title('')
plt.xlabel(r'$\delta$')
plt.ylabel(r'$\rho(G_i)$')
plt.legend(prop={'size': 24}, loc='center left', bbox_to_anchor=(1, 0.5))
plt.show()
